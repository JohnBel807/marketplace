...
<p style="font-size:15px;color:#57534e;">Haz clic para crear una nueva contraseña:</p>
...
<p style="font-size:13px;color:#9a3412;">⏰ Este enlace expira en 30 minutos.</p>
<p style="font-size:13px;color:#a8a29e;">O copia: <a href="{reset_url}" style="color:#ea580c;">{reset_url}</a></p>
</td></tr>
<tr><td style="padding:24px 40px;border-top:1px solid #e7e5e4;text-align:center;">
<p style="font-size:13px;color:#78716c;">johnroa@velezyricaurte.com · Tecnoriente J.B.</p>
</td></tr>
</table></td></tr></table>
</body></html>"""
...
<p style="color:rgba(255,255,255,0.85);margin:8px 0 0;">Tu cuenta en VelezYRicaurte está lista</p>
</td></tr>
<tr><td style="padding:32px 40px 0;">
<div style="background:#fff7ed;border:2px solid #fed7aa;border-radius:12px;padding:20px;text-align:center;">
<p style="margin:0;font-size:13px;color:#ea580c;font-weight:600;">TU REGALO DE BIENVENIDA</p>
...
<p style="font-size:16px;color:#292524;font-weight:600;">Accedes a dos portales con un solo registro:</p>
